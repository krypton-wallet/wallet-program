const {
  ...
  const main = async () => {
    ...
    const acct_len = Buffer.from(new Uint8Array((new BN(5)).toArray("le", 1)));
    ...
    tx.add(initializeSocialWalletIx).add(deleteFromRecoveryIx);
